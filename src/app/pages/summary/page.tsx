...
export default function Summary() {
    ...
    return (
        <div className="w-11/12 md:w-1/2 max-w-7xl mx-auto p-4 flex flex-col justify-between">
            <h1 className="text-dark-orange text-2xl md:text-4xl mb-4 font-semibold">Resumo do Pedido</h1>
            {cartItems.length === 0 ? (
